...
render: ->"""
  <iframe width="368" height="216" src="https://www.youtube.com/embed/UKBvaOLDem0?showinfo=0&theme=dark&keyboard=1&autohide=1&modestbranding=1&rel=0&iv_load_policy=3&loop=0" frameborder="0" allowfullscreen></iframe>
"""
